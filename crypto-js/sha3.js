...
!function() {
    ...
    for (var A = function(e, r, n) {
        ...
        createMethod: function(e, r) {
            var n = b[e]
                , i = B(e, 0, "hex");
            return i.create = function(i, o, s) {
                return o || s ? new t(e,r,i).bytepad([o, s], n) : S["shake" + e].create(i)
            }
                ,
        ...
        createMethod: function(t, r) {
            var n = b[t]
                , i = g(t, 0, "hex");
            return i.create = function(i, o, s) {
                return new e(t,r,o).bytepad(["KMAC", s], n).bytepad([i], n)
            }
                ,
                i.update = function(t, e, r, n) {
        ...
        for (var m = k[x], O = m.bits, z = 0; z < O.length; ++z) {
            var N = m.name + "_" + O[z];
            if (C.push(N),
                    S[N] = m.createMethod(O[z], m.padding),
                "sha3" !== m.name) {
                var j = m.name + O[z];
                C.push(j),
                    S[j] = S[N]
    ...
    t.prototype.update = function(t) {
        if (!this.finalized) {
            ...
            for (var i, o, s = this.blocks, a = this.byteCount, f = t.length, c = this.blockCount, p = 0, d = this.s; p < f; ) {
                if (this.reset)
                    for (this.reset = !1,
                             s[0] = this.block,
                             i = 1; i < c + 1; ++i)
                        s[i] = 0;
                if (e)
                    for (i = this.start; p < f && i < a; ++p)
                        s[i >> 2] |= t[p] << h[3 & i++];
                else
                    for (i = this.start; p < f && i < a; ++p)
                        (o = t.charCodeAt(p)) < 128 ? s[i >> 2] |= o << h[3 & i++] : o < 2048 ? (s[i >> 2] |= (192 | o >> 6) << h[3 & i++],
                            s[i >> 2] |= (128 | 63 & o) << h[3 & i++]) : o < 55296 || o >= 57344 ? (s[i >> 2] |= (224 | o >> 12) << h[3 & i++],
                            s[i >> 2] |= (128 | o >> 6 & 63) << h[3 & i++],
                            s[i >> 2] |= (128 | 63 & o) << h[3 & i++]) : (o = 65536 + ((1023 & o) << 10 | 1023 & t.charCodeAt(++p)),
                            s[i >> 2] |= (240 | o >> 18) << h[3 & i++],
                            s[i >> 2] |= (128 | o >> 12 & 63) << h[3 & i++],
                            s[i >> 2] |= (128 | o >> 6 & 63) << h[3 & i++],
                            s[i >> 2] |= (128 | 63 & o) << h[3 & i++]);
        ...
        t.prototype.encodeString = function(t) {
            ...
            if (e)
                ...
                for (var s = 0; s < t.length; ++s) {
                    ...
                    a < 128 ? i += 1 : a < 2048 ? i += 2 : a < 55296 || a >= 57344 ? i += 3 : (a = 65536 + ((1023 & a) << 10 | 1023 & t.charCodeAt(++s)),
                        i += 4)
                }
        ...
        t.prototype.toString = t.prototype.hex = function() {
            ...
            for (var t, e = this.blockCount, r = this.s, n = this.outputBlocks, i = this.extraBytes, o = 0, s = 0, a = ""; s < n; ) {
                for (o = 0; o < e && s < n; ++o,
                    ++s)
                    t = r[o],
                        a += f[t >> 4 & 15] + f[15 & t] + f[t >> 12 & 15] + f[t >> 8 & 15] + f[t >> 20 & 15] + f[t >> 16 & 15] + f[t >> 28 & 15] + f[t >> 24 & 15];
                s % e == 0 && (J(r),
                    o = 0)
            }
            return i && (t = r[o],
    ...
    ;
    var J = function(t) {
        var e, r, n, i, o, s, a, u, f, c, h, d, l, y, b, A, v, B, g, w, _, k, S, C, x, m, O, z, N, j, J, M, H, I, R, E, U, V, F, D, W, Y, K, q, G, L, P, Q, T, X, Z, $, tt, et, rt, nt, it, ot, st, at, ut, ft, ct;
        for (n = 0; n < 48; n += 2)
